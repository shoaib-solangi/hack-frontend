      ...
      <div className="w-full space-y-6 text-gray-600 sm:max-w-md">
        ...
        <div className="bg-white shadow p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg">
          <div className="grid gap-x-3">
             <button className="flex items-center gap-2 justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100 w-[100%]"> 
               <svg
                className="w-5 h-5"
                viewBox="0 0 48 48"
                fill="none"
        ...
        <div className="text-center">
          <Link href="/ForgetPassword" className="hover:text-indigo-600">
            Forgot password?
          </Link>
        </div>
      </div>
